    ...
    for i in range(20):
        ...
        if boss_turn_skip:
            ...
            if boss_sub <= 8:
                ...
                if isCrit:
                    msg2 = "{}：紫玄掌！！紫星河！！！并且发生了会心一击，造成了{}伤害\r"
                else:
                    msg2 = "{}：紫玄掌！！紫星河！！！造成了{}伤害\r"
                ...
                isCrit, boss_sh = get_turnatk_boss(boss, 0, UserBattleBuffDate("9999999"))  # 判定是否暴击 辅修功法14
                if isCrit:
                    msg2 = "{}：子龙朱雀！！！穿透了对方的护甲！并且发生了会心一击，造成了{}伤害\r"
                else:
                    msg2 = "{}：子龙朱雀！！！穿透了对方的护甲！造成了{}伤害\r"
                play_list.append(get_boss_dict(boss, qx, msg2.format(boss['name'], number_to(
...
def get_turnatk(player, buff=0, user_battle_buff_date=None):  # 辅修功法14
...
def get_skill_sh_data(player, secbuffdata, js):
    skillmsg = ''
